  ...
  return (
    <div className="w-full max-w-md animate-[fade-in_500ms_ease-out]">
      <Card className="overflow-hidden">
        <div className="relative aspect-[4/4.7] overflow-hidden bg-slate-100 dark:bg-stone-800">
        ...
        <div className="p-6 sm:p-7">
          <div className="flex items-start justify-between gap-4"><div><h1 className="font-display text-3xl font-bold tracking-tight text-slate-900 dark:text-stone-100">{pet.name}</h1><p className="mt-1 text-sm font-semibold text-slate-500 dark:text-stone-400">{pet.breed} <span className="mx-1 text-slate-300 dark:text-stone-600">•</span> {pet.age}</p></div><div className="mt-1 rounded-full bg-orange-50 p-2.5 text-orange-500 dark:bg-orange-950/50 dark:text-orange-300"><MapPin size={16} /></div></div>
